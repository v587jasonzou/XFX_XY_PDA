...
public class DownPartsListAdapter extends BaseAdapter {
    Context mContext;
    List<ChildEquipBean> mList;
    ViewHolder holder;
    OnDownClickListner onUpClickListner;
    int status = 0;
    String type = "";
    public DownPartsListAdapter(Context context, List<ChildEquipBean> list, String type) {
        mContext = context;
        mList = list;
        this.type = type;
    }
