...
public class WorkshopTaskDispatchHisActivity extends BaseActivity<WorkshopTaskDispatchListPresenter>
        implements OnViewClickInItemListner, IWorkshopTaskDispatchList {

    private static int ACT_REQUEST_CODE_FWH = 2001;
    private static int ACT_REQUEST_CODE_TICKET = 2002;
    ...
    WorkshopTaskDispatchHisTicketListAdapter ticketAdapter;
    WorkshopTaskDispatchHisFwhListAdapter fwhAdapter;
    ...
    public int getContentViewId() {
        return R.layout.activity_workshoptaskdispatch_his;
    }
    ...
    public void initData() {
        ...
        ticketAdapter = new WorkshopTaskDispatchHisTicketListAdapter(this, mList);
        ticketAdapter.setOnViewClickListner(this);

        fwhAdapter = new WorkshopTaskDispatchHisFwhListAdapter(this, fwhList);
    ...
    private void refreshListData(boolean refresh) {
        ...
        if (0 == tabPosition) {
            ...
            mPresenter.getFwhList(start, IntConstants.PAGE_SIZE, "1", workPlanIdx, type);
            ...
            mPresenter.getTicketList(start, IntConstants.PAGE_SIZE, "true", JSON.toJSONString(param), type);
    ...
    private void firstLoad() {
        ...
        lvTicketList.setAdapter(fwhAdapter);
        mPresenter.getFwhList(start, IntConstants.PAGE_SIZE, "1", workPlanIdx, 0);

        Map<String, String> param = new HashMap<>();
        param.put("workPlanIDX", workPlanIdx);
        mPresenter.getTicketList(start, IntConstants.PAGE_SIZE, "true", JSON.toJSONString(param), 0);
    }
