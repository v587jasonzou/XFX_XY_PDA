...
public class WorkshopTaskDispatchHisTicketListAdapter extends BaseAdapter {
    Context mContext;
    List<FaultTicket> mlist;
    OnViewClickInItemListner onViewClickListner;
    public WorkshopTaskDispatchHisTicketListAdapter(Context context, List<FaultTicket> list) {
        mContext = context;
        mlist = list;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        convertView = LayoutInflater.from(mContext).inflate(R.layout.item_workshoptask_his_ticket, null);
