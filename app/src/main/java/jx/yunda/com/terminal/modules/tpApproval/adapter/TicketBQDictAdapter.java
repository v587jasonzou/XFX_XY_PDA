...
public class TicketBQDictAdapter extends BaseAdapter {
    Context context;
    List<DictBean> list;
    ViewHolder holder;
    OnDicClickListner onDicClickListner;
    public TicketBQDictAdapter(Context context, List<DictBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.tp_approval_dic_item, null);
        ...
        if(entry!=null){
            ...
            holder.tvInfo.setHint(entry.getName());
