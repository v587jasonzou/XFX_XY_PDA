...
public class FwhDoFragment extends BaseFragment<getFwhListPresenter> implements iGetFwhList {
    int start = 0;
    int limit = 8;
    String orgId = "";
    ...
    public void initData() {
        ...
        srRefresh.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                ...
                mPresenter.getFwhList(FlowInfoMainActivity.idx, "1",FlowInfoMainActivity.orgId, start, limit, isLoadMore);
            }
        });
