...
public class UpPartsPresenter extends BasePresenter<IUpParts> {
    public UpPartsPresenter(IUpParts view) {
        super(view);
    }
    public void getUpEquips(String workPlanId , String nodeCaseIDX , String status){
        RequestFactory.getInstance().createApi(TicketApi.class).getUpParts(workPlanId,nodeCaseIDX,status).enqueue(new Callback<BaseBean<ArrayList<ChildUpEquipBean>>>() {
            @Override
    ...
    public void UpEquip(String str){
        RequestFactory.getInstance().createApi(TicketApi.class).UpPartsNew(str).enqueue(new Callback<BaseBean>() {
            @Override
    ...
    public void UpEquipNew(String str){
        RequestFactory.getInstance().createApi(TicketApi.class).UpParts(str).enqueue(new Callback<BaseBean>() {
            @Override
            public void onResponse(Call<BaseBean> call, Response<BaseBean> response) {
                if(response!=null&&response.body()!=null){
                    if(response.body().isSuccess()){
