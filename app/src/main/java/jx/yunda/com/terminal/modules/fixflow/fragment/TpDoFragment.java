...
public class TpDoFragment extends BaseFragment<getTphListPresenter> implements iGetTpList {
    int start = 0;
    int limit = 8;
    String orgId = "";
    ...
    public void initData() {
        ...
        srRefresh.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                ...
                mPresenter.getTpList(FlowInfoMainActivity.idx, "1", FlowInfoMainActivity.orgId, start, limit, isLoadMore);
            }
        });
