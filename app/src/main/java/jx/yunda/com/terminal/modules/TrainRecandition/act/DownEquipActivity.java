...
import jx.yunda.com.terminal.modules.TrainRecandition.presenter.DownEquipPresenter;
import jx.yunda.com.terminal.modules.TrainRecandition.presenter.IDownEquip;
...
public class DownEquipActivity extends BaseActivity<DownEquipPresenter> implements IDownEquip, BaseActivity.OnScanCodeCallBack
        , DownEquipListAdapter.OnDownClickListner {

    List<DownEquipBean> list = new ArrayList<>();
    List<ModulesBean> modulesBeans = new ArrayList<>();
    DownEquipListAdapter adapter;
    Dialog dialog;
    ImageView ivDelete;
    ...
    @Override
    protected DownEquipPresenter getPresenter() {
        return new DownEquipPresenter(this);
    }
    ...
    String workPlanId, nodeCaseIDX, trainTypeIDX, ShortName, TrainNo, unloadPlace;
    int Status = 0;
    ...
    public void initData() {
        ...
        if (bundle != null) {
            tvTicketName.setText(bundle.getString("Trainname"));
        ...
        adapter = new DownEquipListAdapter(this, list, "下配件");
...
//                    }
            ...
            btFinish.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (list.get(EquipPosition).getFairType() != null && list.get(EquipPosition).getFairType().equals("10")) {
...
//                    }
                    ...
                    map1.put("rdpIdx",  list.get(EquipPosition).getRdpIdx());
                    map1.put("unloadTrainType", ShortName);
                    map1.put("unloadTrainNo", TrainNo);
                    Map<String, String> map = new HashMap<>();
...
//                    map1.put("registerArray",JSON.toJSONString(temp));
    ...
    private void setData() {
        ...
        getProgressDialog().show();
        if (Status == 0) {
            mPresenter.getDownEquips(workPlanId, nodeCaseIDX, "1");
        } else {
            mPresenter.getDownEquips(workPlanId, nodeCaseIDX, "2");
        }
    }
    ...
    @Override
    public void getDowmEquipPlansSuccess(ArrayList<DownEquipBean> beans) {
        getProgressDialog().dismiss();
...
//        if(Status==0){
//            if(beans==null||beans.size()==0){
//                new AlertDialog.Builder(this).setTitle("提示").setMessage("所有配件已下车完毕，是否返回任务列表？")
//                        .setNegativeButton("取消",null)
//                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
//                            @Override
//                            public void onClick(DialogInterface dialog, int which) {
//                                setResult(300);
//                                DownEquipActivity.this.finish();
//                            }
//                        }).show();
//            }
//        }
