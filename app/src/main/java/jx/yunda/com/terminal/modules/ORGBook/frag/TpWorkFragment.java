...
import jx.yunda.com.terminal.modules.ORGBook.presenter.TPDispatchPresenter;
...
//范围活fragment
public class TpWorkFragment extends BaseFragment<TPDispatchPresenter> implements ITPWork {
    ...
    int userPosition;
    @Override
    protected TPDispatchPresenter getPresenter() {
        return new TPDispatchPresenter(this);
    }
    ...
    public void initData() {
        ...
        adapter = new DispatchTPListAdapter(getContext(),mList);
        ...
        onTabSelectedListener = new VerticalTabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabView tab, int position) {
                ...
                if(ticketTrainBeans.size()>0){
                    ...
                    param.put("workPlanIDX",ticketTrainBeans.get(position).getWorkPlanIDX());
                    if(tabStatus==0){
        ...
        tbAssign.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(ticketTrainBeans.size()>0){
                    mainAc.getProgressDialog().show();
                    Map<String, String> param = new HashMap<>();
                    param.put("workPlanIDX",ticketTrainBeans.get(EquipPosition).getWorkPlanIDX());
