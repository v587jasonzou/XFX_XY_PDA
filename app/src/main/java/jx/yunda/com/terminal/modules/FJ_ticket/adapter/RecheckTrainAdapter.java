...
public class RecheckTrainAdapter extends BaseAdapter {
    public Context mcontext;
    public List<RecheckTrainBean> list;
    ViewHolder holder;
    public RecheckTrainAdapter(Context context, List<RecheckTrainBean> list){
        mcontext = context;
        this.list = list;
    }
    @Override
